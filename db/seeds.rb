...
Job.create(company_name: "Hudl", job_title: "CEO", description: "run the company, anywhere but into the ground.", salary_range: "$100,001-$200,000", benefits: "everything", location: "Lincoln, NE", requirements: "None", to_apply: "Walk-in")
